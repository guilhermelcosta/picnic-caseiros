...
class FillPermissionsForProdutosCustosIncentivosVenda extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProdutosCustosIncentivosVenda constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.produtos-custos-incentivos-venda',
            'admin.produtos-custos-incentivos-venda.index',
            'admin.produtos-custos-incentivos-venda.create',
            'admin.produtos-custos-incentivos-venda.show',
            'admin.produtos-custos-incentivos-venda.edit',
            'admin.produtos-custos-incentivos-venda.delete',
            'admin.produtos-custos-incentivos-venda.bulk-delete',
        ]);
