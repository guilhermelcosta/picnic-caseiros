...
class FillPermissionsForCanaisVenda extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCanaisVenda constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.canais-venda',
            'admin.canais-venda.index',
            'admin.canais-venda.create',
            'admin.canais-venda.show',
            'admin.canais-venda.edit',
            'admin.canais-venda.delete',
            'admin.canais-venda.bulk-delete',
        ]);
