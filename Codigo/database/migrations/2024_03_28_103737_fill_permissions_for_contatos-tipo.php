...
class FillPermissionsForContatosTipo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContatosTipo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contatos-tipo',
            'admin.contatos-tipo.index',
            'admin.contatos-tipo.create',
            'admin.contatos-tipo.show',
            'admin.contatos-tipo.edit',
            'admin.contatos-tipo.delete',
            'admin.contatos-tipo.bulk-delete',
        ]);
