...
class FillPermissionsForIncentivosVenda extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForIncentivosVenda constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.incentivos-venda',
            'admin.incentivos-venda.index',
            'admin.incentivos-venda.create',
            'admin.incentivos-venda.show',
            'admin.incentivos-venda.edit',
            'admin.incentivos-venda.delete',
            'admin.incentivos-venda.bulk-delete',
        ]);
