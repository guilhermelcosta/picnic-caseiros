...
class FillPermissionsForProdutositem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProdutositem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.produtos-item',
            'admin.produtos-item.index',
            'admin.produtos-item.create',
            'admin.produtos-item.show',
            'admin.produtos-item.edit',
            'admin.produtos-item.delete',
            'admin.produtos-item.bulk-delete',
        ]);
