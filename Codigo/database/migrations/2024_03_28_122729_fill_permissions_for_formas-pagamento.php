...
class FillPermissionsForFormasPagamento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFormasPagamento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.formas-pagamento.index',
            'admin.formas-pagamento.create',
            'admin.formas-pagamento.show',
            'admin.formas-pagamento.edit',
            'admin.formas-pagamento.delete',
            'admin.formas-pagamento.bulk-delete',
        ]);
