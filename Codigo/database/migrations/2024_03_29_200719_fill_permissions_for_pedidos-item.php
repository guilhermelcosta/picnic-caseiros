...
class FillPermissionsForPedidosItem extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPedidosItem constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pedidos-item',
            'admin.pedidos-item.index',
            'admin.pedidos-item.create',
            'admin.pedidos-item.show',
            'admin.pedidos-item.edit',
            'admin.pedidos-item.delete',
            'admin.pedidos-item.bulk-delete',
        ]);
