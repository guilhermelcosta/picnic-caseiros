...
class FillPermissionsForPedidosCancelamento extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPedidosCancelamento constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pedidos-cancelamento',
            'admin.pedidos-cancelamento.index',
            'admin.pedidos-cancelamento.create',
            'admin.pedidos-cancelamento.show',
            'admin.pedidos-cancelamento.edit',
            'admin.pedidos-cancelamento.delete',
            'admin.pedidos-cancelamento.bulk-delete',
        ]);
