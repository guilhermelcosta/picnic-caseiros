...
class FillPermissionsForEndereco extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEndereco constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.endereco',
            'admin.endereco.index',
            'admin.endereco.create',
            'admin.endereco.show',
            'admin.endereco.edit',
            'admin.endereco.delete',
            'admin.endereco.bulk-delete',
        ]);
