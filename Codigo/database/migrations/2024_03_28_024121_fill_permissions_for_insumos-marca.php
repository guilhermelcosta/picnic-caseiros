...
class FillPermissionsForInsumosMarca extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInsumosMarca constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.insumos-marca',
            'admin.insumos-marca.index',
            'admin.insumos-marca.create',
            'admin.insumos-marca.show',
            'admin.insumos-marca.edit',
            'admin.insumos-marca.delete',
            'admin.insumos-marca.bulk-delete',
        ]);
