...
class FillPermissionsForLogradourosTipo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLogradourosTipo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.logradouros-tipo',
            'admin.logradouros-tipo.index',
            'admin.logradouros-tipo.create',
            'admin.logradouros-tipo.show',
            'admin.logradouros-tipo.edit',
            'admin.logradouros-tipo.delete',
            'admin.logradouros-tipo.bulk-delete',
        ]);
