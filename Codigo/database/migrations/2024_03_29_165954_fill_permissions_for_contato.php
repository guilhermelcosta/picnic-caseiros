...
class FillPermissionsForContato extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForContato constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.contato',
            'admin.contato.index',
            'admin.contato.create',
            'admin.contato.show',
            'admin.contato.edit',
            'admin.contato.delete',
            'admin.contato.bulk-delete',
        ]);
