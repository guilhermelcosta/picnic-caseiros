...
class FillPermissionsForProdutosCusto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProdutosCusto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.produtos-custo.index',
            'admin.produtos-custo.create',
            'admin.produtos-custo.show',
            'admin.produtos-custo.edit',
            'admin.produtos-custo.delete',
            'admin.produtos-custo.bulk-delete',
        ]);
