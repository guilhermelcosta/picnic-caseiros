...
class FillPermissionsForInsumosCusto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInsumosCusto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.insumos-custo',
            'admin.insumos-custo.index',
            'admin.insumos-custo.create',
            'admin.insumos-custo.show',
            'admin.insumos-custo.edit',
            'admin.insumos-custo.delete',
            'admin.insumos-custo.bulk-delete',
        ]);
