...
class FillPermissionsForPedidosDesconto extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPedidosDesconto constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.pedidos-desconto',
            'admin.pedidos-desconto.index',
            'admin.pedidos-desconto.create',
            'admin.pedidos-desconto.show',
            'admin.pedidos-desconto.edit',
            'admin.pedidos-desconto.delete',
            'admin.pedidos-desconto.bulk-delete',
        ]);
