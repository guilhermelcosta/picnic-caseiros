...
class FillPermissionsForReceita extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReceita constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.receita',
            'admin.receita.index',
            'admin.receita.create',
            'admin.receita.show',
            'admin.receita.edit',
            'admin.receita.delete',
            'admin.receita.bulk-delete',
        ]);
