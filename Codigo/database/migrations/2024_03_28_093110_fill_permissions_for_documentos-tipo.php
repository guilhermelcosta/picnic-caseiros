...
class FillPermissionsForDocumentosTipo extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDocumentosTipo constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.documentos-tipo',
            'admin.documentos-tipo.index',
            'admin.documentos-tipo.create',
            'admin.documentos-tipo.show',
            'admin.documentos-tipo.edit',
            'admin.documentos-tipo.delete',
            'admin.documentos-tipo.bulk-delete',
        ]);
