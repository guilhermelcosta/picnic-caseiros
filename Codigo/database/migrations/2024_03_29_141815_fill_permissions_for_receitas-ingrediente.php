...
class FillPermissionsForReceitasIngrediente extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForReceitasIngrediente constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.receitas-ingrediente',
            'admin.receitas-ingrediente.index',
            'admin.receitas-ingrediente.create',
            'admin.receitas-ingrediente.show',
            'admin.receitas-ingrediente.edit',
            'admin.receitas-ingrediente.delete',
            'admin.receitas-ingrediente.bulk-delete',
        ]);
