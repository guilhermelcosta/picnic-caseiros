...
class FillPermissionsForFornecedor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFornecedor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.fornecedor.show',
            'admin.fornecedor.edit',
            'admin.fornecedor.delete',
            'admin.fornecedor.bulk-delete',
        ]);
